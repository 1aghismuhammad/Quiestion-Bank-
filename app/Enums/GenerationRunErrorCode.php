...
enum GenerationRunErrorCode: string
{
    ...
    public function userMessage(): string
    {
        return match ($this) {
            ...
            self::AdvancedFeatureRequired => 'Mode lanjutan dengan 1–10 soal membutuhkan tingkat kesulitan berbeda, tipe soal berbeda, atau pengacakan soal, atau pengacakan opsi.',
