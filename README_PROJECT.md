...
- Phase 5.7: pre-Phase-6 enhancements (`IN PROGRESS`). Phase 5.7A–5.7B3 are `COMPLETE`. Phase 5.7C+D third corrective QA passed and is pending review (v0.15.9). Phase 5.7E (Advanced Mode, shuffle, Run Question Bank import, question DOCX) is `NOT STARTED`.
