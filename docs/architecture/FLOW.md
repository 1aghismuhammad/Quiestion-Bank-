...
- Phase 5.7C+D Blueprint dan Simple Generation Run UI, plus Phase 5.7E Advanced MCQ UI, menggunakan Blade/controller dan vanilla JS polling bounded, tanpa Livewire/React/Vue/websockets.
