...
- Phase 5.7B3 profile UI, Phase 5.7C+D Blueprint/Run UI, dan Phase 5.7E Advanced MCQ UI wajib Blade/controller + vanilla JS bounded; jangan Livewire, React, Vue, Alpine (kecuali sudah ada), atau websockets
...
- Phase 5.7F (`NOT STARTED`): True/False dan Essay. Jangan menambah UI atau kode itu.
