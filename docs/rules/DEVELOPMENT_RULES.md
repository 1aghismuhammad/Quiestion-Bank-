...
- Phase 5.7B3 profile UI, Phase 5.7C+D Blueprint/Run UI, Phase 5.7E Advanced MCQ UI, dan Phase 5.7F True/False/Essay UI wajib Blade/controller + vanilla JS bounded; jangan Livewire, React, Vue, Alpine (kecuali sudah ada), atau websockets
